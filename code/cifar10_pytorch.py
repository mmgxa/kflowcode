...
parser.add_argument("--ptl_args", type=str, help="Arguments specific to PTL trainer")
...
early_stopping = EarlyStopping(monitor="val/loss", mode="min", patience=5, verbose=True)
# early_stopping = EarlyStopping(monitor="val/acc", mode="max", patience=5, verbose=True)
